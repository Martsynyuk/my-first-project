...
class Contacts_controllers extends Controller_controllers
{
	...
	public function  add_contact ()
	{
		...
		if ( ! empty ( $_POST ['FirstName'] ) ) 
		{
			...
			if( $new_contact === 'No connect' )
			{
					...
					header('Location: /contacts_controllers/addcontact');
			}
		}
	...
	public function edit_contact ()
	{
		...
		if ( ! empty ( $_POST ['FirstName'] ) ) 
		{
			...
			if ( $update_contact === 'No connect' )
			{
				...
				header ( 'Location: /contacts_controllers/editcontact' );
			}
	...
	public function index ()
	{
		...
		$userContact = new Contacts_controllers ();
		...
		$editcontact = "/contacts_controllers/edit_contact?id=";
		$viewcontact = "/contacts_controllers/view_contact?id=";
		$deletecontact = "/contacts_controllers/index?id=";
